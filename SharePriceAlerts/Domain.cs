namespace SharePriceAlerts
{
    ...
    public class DayPriceInformation { public string Symbol { get; set; } public DailyPrice DailyPrice { get; set; } }
    public class RuleOutcomeDetails { public bool TestPassed { get; set; } public string Symbol { get; set; } }
    ...
    public delegate IDictionary<string, PriceInformationTest> GetAllTests();
    ...
    public delegate void AlertWhereRequired(IEnumerable<RuleOutcomeDetails> ruleOutcomeDetails);
}